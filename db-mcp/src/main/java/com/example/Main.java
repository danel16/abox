...
public class Main {
    ...
    public static void main(String[] args) {
        try {
            ...
            MCPServer server = new MCPServer("db-mcp", config);
            ...
            logger.info("Starting db-mcp MCP server with {} tools", tools.size());
    ...
    private static void printUsage() {
        System.out.println("Usage: java -cp target/db-mcp-0.1.0.jar com.example.Main [options]");
